...
interface DataTableProps<Notifications, TValue> {
    columns: ColumnDef<Notifications, TValue>[]
    data: Notifications[]
}

export function NotificationsDataTable<Notifications, TValue>({
    columns,
    data, 
}: DataTableProps<Notifications, TValue>) {
